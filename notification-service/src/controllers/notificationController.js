...
class NotificationController {
    ...
    async createLikeNotification(req, res) {
        try {
            ...
            if (!commentId || !likedByUserId) {
                return res.status(400).json({ error: 'commentId and likedByUserId are required' });
            }
    ...
    async createReplyNotification(req, res) {
        try {
            ...
            if (!parentCommentId || !replyCommentId || !repliedByUserId) {
                return res.status(400).json({ 
                    error: 'parentCommentId, replyCommentId and repliedByUserId are required' 
                });
            }
